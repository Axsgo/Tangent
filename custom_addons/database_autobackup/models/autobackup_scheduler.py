...
class AutoBackupScheduler(models.Model):
    ...
    def cron_database_autobackup(self):
        _logger.info(":::: Autobackup Scheduler Started ::::")
        ...
        if autobackup_enabled:
            ...
            _logger.info(":::: Autobackup Scheduler Feedback Unix Code (Backup): %s ::::" % unix_code)
        _logger.info(":::: Autobackup Scheduler Finished ::::")
